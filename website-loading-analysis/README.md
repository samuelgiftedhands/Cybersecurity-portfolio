...
A step-by-step technical analysis of what happens when a URL is entered into a web browser.
...
This project documents the complete journey a website takes from the moment a user enters a URL into a browser until the webpage is displayed.

It explains the networking protocols and technologies working behind the scenes, including:
...
The goal is to build a solid foundation in networking and cybersecurity.
